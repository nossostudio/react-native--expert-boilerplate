  ...
  return (
    <View style={styles.SectionListItem}>
      <View>
        ...
        <Text style={{ position: 'absolute', top: 10, left: 8, fontWeight: 'bold', fontSize: 20 }}>
    ...
    return (
      <View style={styles.container}>
        ...
        <SectionList
          ...
          renderItem={({ item }) => (
            <SectionListItem date={item.day} restingTime={item.restingTime} productionTime={item.productionTime} />
          )} />
      </View>
    )
  }
